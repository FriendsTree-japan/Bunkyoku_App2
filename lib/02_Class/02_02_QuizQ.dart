...
class QuizQ_List {
  Map<String, QuizQ> list = {
    ...
    '15': QuizQ(
        QID: '15',
        Picture: '',
        problem: '文京区観光協会では、観光ガイドツアーを行なっております。そのツアー数は次のうちどれでしょうか？',
        Select1: '3',
        Select2: '5',
        Select3: '7',
        Select4: '10',
    ...
    '26': QuizQ(
        ...
        Picture: '',
        problem:
            '平成29年に「新江戸川公園」から名称変更された、園内に学問所として使われていた建物「松聲閣」がある施設は次のうちどれでしょうか？',
        Select1: '江戸川公園',
        Select2: '肥後細川庭園',
        Select3: '白山公園',
        Select4: '須藤公園',
    ...
    '34': QuizQ(
        QID: '34',
        Picture: '',
        problem: '文京区観光協会の準公式キャラクターの名前は次のうちどれでしょうか？',
        Select1: 'ぶんこちゃん',
        Select2: 'ぶんたろう',
        Select3: 'きょうちゃん',
        Select4: 'きょうたろう',
    ...
    '45': QuizQ(
        QID: '45',
        Picture: '',
        problem: '以前は「鴎外記念◯◯図書館」という名前で運営されていた図書館は、次のうちどれ？',
        Select1: '小石川図書館',
        Select2: '本郷図書館',
        Select3: '真砂中央図書館',
        Select4: '根津図書館',
