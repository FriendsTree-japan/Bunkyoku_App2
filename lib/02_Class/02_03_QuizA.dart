...
class QuizA_List {
  Map<String, QuizA> list = {
    ...
    '26': QuizA(
        ...
        Commentary: '幕末は熊本の細川家の下屋敷・抱屋敷でしたが、戦後所有者が変わり、昭和34年に東京都が買収し「新江戸川公園」と名付けられました。\n「肥後細川庭園」と名付けられたのは平成29年でかなり最近のようです。\n大きな池を中心として、その周りを一周したり、後ろに見える台地となっている樹林地をゆくと、永青文庫にも行けます(休館時は通れません)。\n四季折々の草木が生えているので、いつ行っても自然が美しい庭園となっています。',
    ...
    '38': QuizA(
        ...
        Commentary: 'あまりにも美しい本棚なので、思わず「うおー」となります。「館内を回ってちょっと疲れたな」ってときには、館内にカフェが併設されているので、そこでゆっくりするのがおすすめです！',
        Tips:
