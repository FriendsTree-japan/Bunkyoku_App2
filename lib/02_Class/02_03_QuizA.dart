...
class QuizA_List {
  Map<String, QuizA> list = {
    ...
    '29': QuizA(
        QID: '29',
        Answer: '港区',
        Picture: 'images/answer/ans_029.jpg',
        Commentary:
    ...
    '38': QuizA(
        ...
        Commentary:
            'あまりにも美しい本棚なので、思わず「うおー」となります。「館内を回ってちょっと疲れたな」ってときには、館内にカフェが併設されているので、そこでゆっくりするのがおすすめです！',
        Tips:
    ...
    '40': QuizA(
        QID: '40',
        Answer: '300円',
        Picture: 'images/answer/ans_040.jpg',
        Commentary:
    ...
    '46': QuizA(
        QID: '46',
        Answer: '石川啄木',
        Picture: 'images/answer/ans_046.jpg',
        Commentary:
    ...
    '48': QuizA(
        QID: '48',
        Answer: '春日局',
        Picture: 'images/answer/ans_048.jpg',
